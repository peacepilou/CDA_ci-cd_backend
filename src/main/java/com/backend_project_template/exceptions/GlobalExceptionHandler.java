...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<String> handleUserNotFoundException(UserNotFoundException ex) {
    return ResponseEntity.status(404).body("Item not found: " + ex.getMessage());
  }

  @ExceptionHandler({ OrderDomainException.class, UserDomainException.class, OrderItemDomainException.class })
